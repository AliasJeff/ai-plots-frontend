export default [
...

  {
    ...
    routes: [
      { path: '/text/add_text', name: '智能分析文本', component: './Text/AddTextMQ' },
      { component: './404' },
    ],
  },
  {
  ...
  { path: '/gen_chart', name: '我的图表', icon: 'SlidersTwoTone', component: './ChartManage' },
  { path: '/gen_text', name: '我的文本', icon: 'ProfileTwoTone', component: './TextManage' },
  {
