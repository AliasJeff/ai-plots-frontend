...
} from '@/services/AiPlots/AiAssistantController';
              ...
              <>
                ...
                {item.questionStatus === 'succeed' && (
                  <>
                    ...
                    <Divider />
                    <Row justify={'start'}>
                      <Col>{'回答时间：' + new Date(item.createTime).toLocaleString()}</Col>
                    </Row>
                    <Row justify={'end'}>
                      <Col>
                        <Button danger onClick={() => handleDelete(item.id)}>
                ...
                {item.questionStatus === 'failed' && (
                  <>
                    <Result status="error" title="回答失败" subTitle={item.execMessage} />
                    <Row justify="end">
